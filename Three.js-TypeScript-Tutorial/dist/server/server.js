...
class App {
    constructor(port) {
        ...
        // );
        app.use("/dist/cannon-es", express_1.default.static(path_1.default.join(__dirname, "../../node_modules/cannon-es/dist/cannon-es.js")));
        app.use("/jsm/geometries/ConvexGeometry", express_1.default.static(path_1.default.join(__dirname, "../../node_modules/three/examples/jsm/geometries/ConvexGeometry")));
